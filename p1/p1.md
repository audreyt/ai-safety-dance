...
>
> 最終，AI（正確地！）推斷它可以通過獲得更多計算資源來最大化計算。<i>甚至可能通過偷竊它們。</i>所以，AI 駭入了它運行的電腦，通過電腦病毒逃到互聯網上，劫持了世界各地數百萬台電腦，全部作為一個巨大的連接殭屍網路⋯⋯<i>只是為了計算圓周率的數字。</i>
>
...
更重要的是，Alan Turing（提醒：計算機科學和 AI 的創始人）是一個相關想法的早期粉絲——<i>機器可以像人類大腦一樣從資料中自己學習。</i> Turing 甚至建議我們可以像訓練狗一樣訓練機器：用獎勵和懲罰。多麼有遠見——那實際上<i>就是</i>我們現在訓練大多數 ANN 的方式！（「強化學習」）[^turing-rl]
...
[^sym-vs-conn]: 要了解更多關於符號 AI 和連接主義 AI 之間學術競爭的歷史，請參閱這篇標題驚人的論文中美麗的資料視覺化：[Cardon, Cointet & Mazières (2018), <b><i>NEURONS SPIKE BACK</i></b>](https://mazieres.gitlab.io/neurons-spike-back/index.htm#footnotes)
...
* Frank Rosenblatt——Mark I 感知器的創造者，第一台使用人工神經元<i>並且</i>從資料中自己學習的機器——1971 年（43 歲）死於划船事故。
...
當 AI 在與其訓練資料不同的場景中失敗時，這被稱為<b>「分布外錯誤」</b>，或<b>「穩健性失敗」</b>。
